...
Separate classic hemispherical and contour-based estimates with geometry uncertainty. This skill supports research and decision-support development only; it must not be used to claim autonomous clinical diagnosis.

## Trigger Conditions

Use this skill when the active Codex task matches the description above or when an AgentTask lists ar-pisa-analysis in required_skills. Do not use it outside AR-focused echocardiography research workflows.
