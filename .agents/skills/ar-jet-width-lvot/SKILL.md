...
Measure exact lines at the same level and apply ASE jet-width/LVOT categories with limitations. This skill supports research and decision-support development only; it must not be used to claim autonomous clinical diagnosis.

## Trigger Conditions

Use this skill when the active Codex task matches the description above or when an AgentTask lists ar-jet-width-lvot in required_skills. Do not use it outside AR-focused echocardiography research workflows.
